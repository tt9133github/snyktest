    ...
    <div style="background-color:white;min-height:850px;padding: 10px;">
      ...
      <div>
        <div class="border-style">
          <h4><a><i class="el-icon-tickets"></i></a>&nbsp;&nbsp;项目基础信息及检测概览</h4>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="box box-solid box-default box-style">
              <div class="box-header with-border">
                <p>
                  <b>
                    <i class="fa fa-folder-open-o"></i>&nbsp;&nbsp;检测结构概要</b>
                  <!--Project details-->
                </p>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <ul class="list-group list-group-unbordered">
                  <li class="list-group-item">项目总容量
                    <span class="pull-right">{{result.l_total_size}} KB / {{result.r_total_size}} KB</span>
                  </li>

                  <li class="list-group-item">文件总数
                    <span class="pull-right">{{result.l_total_files}} / {{result.r_total_files}}</span>
                  </li>
                  <li class="list-group-item">总行数
                    <span class="pull-right">{{result.l_whole_line_num}} / {{result.r_whole_line_num}}</span>
                  </li>
                  <li class="list-group-item">原文件（Hash）匹配（行）
                    <span class="pull-right">{{result.l_hash_line_num}}</span>
                  </li>
                  <li class="list-group-item">文件级匹配（行）
                    <span class="pull-right">{{result.l_file_line_num}} / {{result.r_file_line_num}}</span>
                  </li>
                  <li class="list-group-item">代码级匹配（行）
                    <span class="pull-right">{{result.l_fragment_line_num}} / {{result.r_fragment_line_num}}</span>
                  </li>
                  <li class="list-group-item">原创（行）
                    <span class="pull-right">{{result.l_whole_line_num - result.l_hash_line_num - result.l_file_line_num - result.l_fragment_line_num}} /
                      {{result.r_whole_line_num - result.l_hash_line_num - result.r_file_line_num - result.r_fragment_line_num}}</span>
                  </li>
                </ul>
              </div>
              <!-- /.box-body -->
          ...
          <div class="col-md-7">
            <div class="box box-solid box-default box-style">
              <div class="box-header with-border">
                <p>
                  <b>
                    <i class="fa fa-folder-open-o"></i>&nbsp;&nbsp;检测项目成份分析
                  </b>
                </p>
              </div>
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div style=" width: 400px;height: 400px;" id="elementBarL"></div>
                  </div>
                  <div class="col-md-6">
                    <div style=" width: 400px;height: 400px;" id="elementBarR"></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="match_file" v-show="active == 3">
        <div class="border-style">
      ...
      <div class="modal-dialog modal-code" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row n">
              <div class="col-md-6">
                <pre class="code-body slim-bar">{{check_fragment}}</pre>
              </div>
              <div class="col-md-6">
    ...
    methods: {
      ...
      codeCompare(row) {
        ...
        if (row.same_fragment_content == null) {
          this.$http.get("/api/clone/pair/match/file/" + this.task_id,
            {
              params:
                {
                  match_type: row.match_type,
                  check_path: this.result.l_prefix + "/" + row.lpath,
