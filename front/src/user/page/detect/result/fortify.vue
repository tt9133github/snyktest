  ...
  <div class="row detect_page">
    <div class="col-md-12">
      <section class="content bg-style">
        <div class="row">
          <div class="col-md-12">
            <div class="box box-solid box-default" id="upload_box">
              <div class="box-header with-border">
                <p data-widget="collapse" class="pointer">
                  <b><i class="fa fa-folder-open-o"></i>&nbsp;&nbsp;
                    上传Fortify报告文件</b></p>
              ...
              <div class="box-body ">
                <div class="col-md-6">
                  <el-upload
                    ...
                    <div class="el-upload__text">请同时将XML格式的报告和PDF格式的报告拖到此处，或<em>点击选择XML和PDF文件</em>
                    </div>
                  </el-upload>
                  <el-button type="primary" @click="submitXPUpload">确定上传
                  </el-button>
                </div>
                <div class="col-md-6">
                  <span>日志:</span>
                  <div v-for="(f, index) in fortifyLog">
                    <span v-if="index > 0">{{f}}</span>
                  </div>
                  <span v-if="fortifyLog.length < 2">暂无返回日志</span>
                </div>
              </div>
            </div>
          </div>
